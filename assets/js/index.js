...
function clickDeleteLookup(name) {
  ...
  localStorage.setItem('selectedCustomizationValues', JSON.stringify(selectedCustomizationValues))
  renderlookup()
}
...
function renderProposed() {
  ...
  bundleLista.innerHTML = ''
  let ProposedCustomization = JSON.parse(localStorage.getItem('ProposedCustomization'))  
  let i = 0
...
function clickDeletePoposed(name) {
  ...
  localStorage.setItem('ProposedCustomization', JSON.stringify(ProposedCustomization))
  renderProposed()
}
